...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x =[2.1845,0.9615,0.6110,0.2024];           % 20150611-hybrid_GA_fminsearch_wings_morphology_6-结果
% x =[3.6837,1.7620,2.0000,0.0055];           % 20150609-WingM5_4_10variable_group-Result
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % 固定气动力系数 % 20160305-hybrid_GA_fminsearch_WGP_7_4_fixed_C_F_2
% % x =[2.4370,0.9626,0.3574,0.0000]; % fval =20.4839; AR =2.9029; Re=157.6046; 
% x =[2.4370405e+000  9.6264170e-001  3.5736539e-001  5.3735407e-012];%为上一行的精确值 
%%%%%%%%%%%%%%%%%%%%%%%%%
% % 变气动力系数 % 20160306-hybrid_GA_fminsearch_WGP_7_4_variable_C_F_2
% %  x =[2.6843,0.9882,0.2315,0.1443];%  fval =21.1160; AR =2.9506; Re=168.8122; 
% x=[2.6842518e+000  9.8818826e-001  2.3149361e-001  1.4433740e-001];  % 为上一行的精确值 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 固定气动力系数 % 20160316-WingM6_3_10variable_group_Wang_wingbeatM_计算结果
...
% x =[3.9812634e+0,1.9600006e+0,1.7844515e+0,7.9074669e-005];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 变气动力系数 % 20160316-WingM6_3_10variable_group_Wang_wingbeatM_计算结果
...
x =[4.0e+0,1.9110757e+0,1.8117575e+0,1.9869022e-003];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
R_wing=x(1);
C_aver=x(2);
...
quiver(-0.25,0,...                                                              % 起点
            6.75,0,1,'k-','LineWidth',2);   hold on;                  % 终点   1倍显示——X轴         
quiver(0,-1.5,...                                                                 % 起点
           0,3.5,1,'k-','LineWidth',2);   hold on;                      % 终点   1倍显示 ——Z轴  
% 翅根部——root-x轴——x轴    
...
quiver(0, C_lead_ymax-C_maxyaxis*C_max_LtoT,...                                  % 起点
